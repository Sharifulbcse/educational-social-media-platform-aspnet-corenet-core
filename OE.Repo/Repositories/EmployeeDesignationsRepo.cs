...
namespace OE.Repo
{
    public class EmployeeDesignationsRepo<T> : IEmployeeDesignationsRepo<T> where T : EmployeeDesignations
    {
        private readonly OurEduMediaContext context;
        private DbSet<T> entities;
        string errorMessage = string.Empty;

        public EmployeeDesignationsRepo(OurEduMediaContext context)
        {

...
namespace OE.Repo
{
    public class ClassTimeScheduleActionDatesRepo<T> : IClassTimeScheduleActionDatesRepo<T> where T : ClassTimeScheduleActionDates
    {
        private readonly OurEduMediaContext context;
        private DbSet<T> entities;
        string errorMessage = string.Empty;

        public ClassTimeScheduleActionDatesRepo(OurEduMediaContext context)
        {

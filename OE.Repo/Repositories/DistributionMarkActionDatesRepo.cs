...
namespace OE.Repo
{
    public class DistributionMarkActionDatesRepo<T> : IDistributionMarkActionDatesRepo<T> where T : DistributionMarkActionDates
    {
        private readonly OurEduMediaContext context;
        private DbSet<T> entities;
        string errorMessage = string.Empty;

        public DistributionMarkActionDatesRepo(OurEduMediaContext context)
        {

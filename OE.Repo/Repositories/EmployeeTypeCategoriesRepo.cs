...
namespace OE.Repo
{
    public class EmployeeTypeCategoriesRepo<T> : IEmployeeTypeCategoriesRepo<T> where T : EmployeeTypeCategories
    {
        private readonly OurEduMediaContext context;
        private DbSet<T> entities;
        string errorMessage = string.Empty;

        public EmployeeTypeCategoriesRepo(OurEduMediaContext context)
        {

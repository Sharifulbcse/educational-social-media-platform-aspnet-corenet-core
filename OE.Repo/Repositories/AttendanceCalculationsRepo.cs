...
namespace OE.Repo
{
    public class AttendanceCalculationsRepo<T> : IAttendanceCalculationsRepo<T> where T : AttendanceCalculations
    {
        private readonly OurEduMediaContext context;
        private DbSet<T> entities;
        string errorMessage = string.Empty;

        public AttendanceCalculationsRepo(OurEduMediaContext context)
        {

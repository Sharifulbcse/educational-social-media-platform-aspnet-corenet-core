...
namespace OE.Repo
{
    public class OE_UserAuthenticationsRepo<T> : IOE_UserAuthenticationsRepo<T> where T : OE_UserAuthentications
    {
        private readonly OurEduMediaContext context;
        private DbSet<T> entities;
        string errorMessage = string.Empty;

        public OE_UserAuthenticationsRepo(OurEduMediaContext context)
        {
